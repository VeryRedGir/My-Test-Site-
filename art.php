...
<html>
  <table border="1">
   ...
   foreach(array_keys($photoArray) as $photo){
   	   $imageData = getimagesize($photoArray[$photo]['url']);
   	   $height = $imageData[1]/2;
   	   $width = $imageData[0]/2;
	   echo "<td><h2 align='center'><p>".$photoArray[$photo]['date']."</p></h2>\n";
	   echo "<img src='".$photoArray[$photo]['url']."' height='".$height."' width='".$width"' /></td>";
   }
   ?> 
     </td>   
   </tr>    
